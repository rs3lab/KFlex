...
#ifndef FFKX_BPF_FFKX_JHASH_BPF_H
#define FFKX_BPF_FFKX_JHASH_BPF_H
// clang-format off
#include <vmlinux.h>
// clang-format on
...
#define rol32(word, shift) (word << (shift & 31)) | (word >> ((-shift) & 31))
 ...
 */
static __noinline u32 jhash2(const u32 *k, u32 length, u32 initval) {
  u32 a, b, c;
